//! `pacvamp-repo attest`: a build provenance statement per package, in a
...
pub const BUILD_TYPE: &str = "https://pacvamp.com/build/makepkg/v1";
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct Builder {
    /// `pacvamp-repo attest` plus the build key id.
    pub id: String,
}
