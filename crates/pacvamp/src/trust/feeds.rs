...
/// `pacvamp-index.json`: what the repository currently serves.
    ...
    fn later_verdict_from_the_same_reviewer_supersedes_an_earlier_one() {
        let feed: Verdicts = serde_json::from_str(
            r#"{"version":1,"sequence":2,"issued_at":"2026-09-03T00:00:00Z","verdicts":[
              {"subject":{"pkgbase":"yay","commit":"abc"},"reviewer":{"kind":"static","id":"pacvamp-policy","version":"1"},"verdict":"block","issued_at":"2026-09-01T00:00:00Z"},
              {"subject":{"pkgbase":"yay","commit":"abc"},"reviewer":{"kind":"human","id":"alice"},"verdict":"pass","issued_at":"2026-09-01T00:00:00Z"},
              {"subject":{"pkgbase":"yay","commit":"abc"},"reviewer":{"kind":"static","id":"pacvamp-policy","version":"2"},"verdict":"pass","issued_at":"2026-09-03T00:00:00Z"}
            ]}"#,
        )
        .unwrap();
